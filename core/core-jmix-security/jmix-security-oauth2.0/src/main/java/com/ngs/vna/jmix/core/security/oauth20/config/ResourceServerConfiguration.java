 ...
 */
package com.ngs.vna.jmix.core.security.oauth20.config;
...
public class ResourceServerConfiguration implements Ordered {
    ...
    @Autowired(required = false)
    private AuthorizationEndpointsConfiguration endpoints;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        if (endpoints != null) {
            ...
            http.authorizeHttpRequests((authz) -> {
                try {
                    authz
                            .requestMatchers(new NotOAuthRequestMatcher(endpoints.oauth2EndpointHandlerMapping())).permitAll()
